...
public class StudentTest1 {
	...
	public static void main(String[] args) {
		...
		- Stack Area :
		메서드 안에 변수및매개변수 선언하면, 메서드가 실행이 될때 변수의 기억장소가 생성.
		...
		*/
		...
		//기본데이타타입을 이용하여 메서드안에서 변수를 선언하면, 기억장소는 스택영역에 생성된다.
		//클래스 변수(객체)로 선언하면, 스택영역에 4바이트 크기로 생선한다.
		//생성된 기억장소에는 앞으로 힙영역에 생성 될 주소가 된다.
		...
		// chapter5.classpart2.Student@75a1cd57 : 패키지명.클래스@주소값
